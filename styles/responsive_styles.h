...
// Implements Melt effect for cutting through object, size will change to mimic metal heating and intensity will increase or decrease based on turning hilt
// TRANSITION1 & TRANSITION2 = transition Begin & End
// SIZE1 & SIZE2 control MELT area limits for TwistAngle

template<class COLOR = Mix<TwistAngle<>,OrangeRed,Red>, class TR1 = TrWipeIn<600>, class TR2 = TrWipe<600>, int SIZE1 = 4000, int SIZE2 = 10000 >
using ResponsiveMeltL = LockupTrL<AlphaL<COLOR, SmoothStep<Int<30000>,Scale<TwistAngle<>,Int<SIZE1>,Int<SIZE2>>>>, TR1, TR2, SaberBase::LOCKUP_MELT> ;
