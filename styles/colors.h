...
typedef Rgb<118, 0 194> DeepPurple;
...
typedef Rgb<85, 85, 200> Glacier;
typedef Rgb<180, 130, 0> Gold;
typedef Rgb<0, 255, 0> Green;
typedef Rgb<108, 255, 6> GreenYellow;
typedef Rgb<223, 255, 223> HoneyDew;
typedef Rgb<255, 36, 118> HotPink;
typedef Rgb<30, 60, 200> IceBlue;
typedef Rgb<80, 50, 210> Indigo;
...
typedef Rgb<115, 15, 240> Purple;
typedef Rgb<255, 0, 0> Red;
typedef Rgb<255, 233, 219> SeaShell;
typedef Rgb<100, 100, 150> Silver;
