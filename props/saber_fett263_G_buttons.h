...
#ifndef LOCKUP_THRESHOLD_G
#define LOCKUP_THRESHOLD_G 2.0
#endif 
...
SaberFett263Buttons() : PropBase() {}
  ...
  void Loop() override {
    ...
    if (!swinging_ && fusor.swing_speed() > 120 && fusor.swing_speed() < 250 && millis() > clash_swing_ + (100 * LOCKUP_THRESHOLD_G)) {
