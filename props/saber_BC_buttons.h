...
public:
  ...
  void Loop() override {
    ...
    if (scroll_presets_timer_trigger_ && DelayTimer(scroll_presets_timer_trigger_, last_timer_time_, beep_seq_duration_ * 1000)) {
        if (scroll_presets_) {
...
// Toggle Scroll Presets
  case EVENTID(BUTTON_POWER, EVENT_FIRST_HELD_MEDIUM, MODE_OFF):
    ...
    if (scroll_presets_) {
      ...
      beep_seq_duration_ = 0.35;  // .05 breathing room
