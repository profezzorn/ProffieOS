...
Features:
- Live preset changing while blade is running (skips preon).
...
Optional #defines:
#define FEMALE_TALKIE_VOICE     - To use a female voice version of the spoken prompts
...
Auto Spins Blast      - Same as Auto Swing Blast mode.....but for Spins,          // BC Personal Version Only
